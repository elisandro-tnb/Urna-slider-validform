/* Variaveis de controle Interface */
...
function branco(){
    if(numero === ''){
       ...
       // descricao.innerHTML = '';
       // aviso.style.display = 'blocke';
       // lateral.innerHTML = '';
        numeros.innerHTML = '';
        descricao.innerHTML = `<div class = "aviso--grande pisca">VOTO BRANCO</div>`;
    }else{
        alerta('Não pode ter digitos para voto em branco!');
    }
}
...
function confirma(){
   ...
   /*  codar verificar se nulo ou nao aqui ? */
    if(votoBranco === true){
        votoConfirmado = true;
        votos.push({
...
function AtualizaInterface(){
   // console.log("Atualizando Interface");
    console.log('Confirmacao de voto para:'+numero);
   // console.log('funcao de desvio de voto executada,  gravado voto para: 18001 ');
